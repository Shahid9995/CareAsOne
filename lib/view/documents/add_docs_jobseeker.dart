...
import 'package:careAsOne/controller/JobSeeker/add_docs_jobseeker_controller.dart';
...
class AddDocsJobSeeker extends StatelessWidget {
  const AddDocsJobSeeker({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<AddDocsJobSeekerController>(
        init: AddDocsJobSeekerController(),
        builder: (_) {
          return Scaffold(
