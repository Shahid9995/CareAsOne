...
import 'package:careAsOne/controller/JobSeeker/playvideo_jobseeker.dart';
...
class PlayVideoJobKeeper extends StatelessWidget {
                ...
                actions: [
                  ...
                  InkWell(
                    ...
                    child: Padding(
                      ...
                      child: IconButton(icon: Icon(Icons.menu,color: AppColors.green,),onPressed: (){
                        Get.back();
                      },)
