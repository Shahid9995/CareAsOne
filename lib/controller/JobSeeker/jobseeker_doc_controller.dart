...
class JobSeekerDocsController extends GetxController {
  var token;
  ...
  String docName="";
  List<ReceivedDocsModel> searchedDocList=[];
  String recDocName="";
  ...
  Future<List<DocsModel>> getDocsList(token) async {
    ...
    try {
      ...
      if (response!.statusCode == 200) {
        if (response.data["data"]["allDocuments"] != null) {
          response.data["data"]["allDocuments"].forEach((ele) {
  ...
  deleteDocument(List idList) async{
    ...
    var response=await http.post(
      Uri.parse('${BaseApi.domainName}api/job-seeker/delete-documents?api_token=$token'),
  ...
  Future<void> deleteReceivedDocument(BuildContext context, idList,
  ...
  Future<void> deleteSharedDocument(BuildContext context, idList,
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse('${BaseApi.domainName}api/employer/share-document-delete?api_token=$token'));
  ...
  Future showReceivedSelectionDialog(BuildContext context, List idList) {
    return showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
                        ...
                        Align(
                          ...
                          child: MaterialButton(
                            ...
                            onPressed: () async {
                              ...
                              await deleteReceivedDocument(context, idList);
                            },
                          ),
                        ),
                      ],
